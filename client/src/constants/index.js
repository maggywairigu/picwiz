export const surpriseMePrompts = [
    ...
    "A futuristic cityscape where hoverboards are the primary mode of transportation",
    "A magical forest where squirrels breakdance and trees tell jokes",
    "An underwater adventure with a DJ jellyfish throwing an epic dance party",
    "A steampunk-inspired flying machine race with racers in top hats and goggles",
    "A serene mountain landscape where llamas roam freely, wearing sunglasses",
    "An alien marketplace on a distant planet selling intergalactic street food",
    "A whimsical tea party with talking animals discussing philosophy",
    "A time-traveling explorer encountering dinosaurs who are obsessed with smartphones",
    "A cyberpunk street scene with neon lights and skateboarding robots",
    "A floating island with gravity-defying architecture where people surf on rainbows",
    "A dramatic space battle between starships, but they settle things with a dance-off",
    "A haunted mansion shrouded in mist, hosting a costume party for friendly ghosts",
    "A peaceful countryside with rolling hills and grazing sheep who love playing soccer",
    "A bustling market in a Moroccan-inspired city where merchants speak in memes",
    "A journey through a wormhole to another dimension filled with adorable alien pets",
    "A hidden cave filled with sparkling crystals that sing when touched",
    "A futuristic sports arena with high-tech equipment and athletes on jetpacks",
    "A group of adventurers riding mythical creatures in a race around the world",
    "A post-apocalyptic landscape reclaimed by nature, with mutant plants that DJ",
    "A masquerade ball in an opulent Venetian palace where everyone wears cosplay",
    "An ancient temple in the heart of the jungle, guarded by mischievous monkeys",
    "A floating city above the clouds, where the main mode of travel is giant balloons",
    "A tranquil lakeside cabin under the stars, with marshmallow-roasting aliens",
    "A space colony on a distant exoplanet, where aliens have a fascination with memes",
    "A surreal landscape where land and sea merge, and mermaids ride flamingos",
    "A caravan crossing a vast desert with sand dunes that double as snowboarding ramps",
    "An enchanted library with books that come to life and offer relationship advice",
    "A grand steampunk-inspired train traveling through a canyon, powered by laughter",
    "A futuristic laboratory conducting experiments on dancing robots and breakdancing chemicals",
    "A whimsical carousel with mythical creatures as rides, complete with a unicorn DJ",
    "A city inhabited by humanoid animals, holding a talent show with beatboxing pandas",
    "A Viking ship navigating through icy waters, with crew members singing sea shanties",
    "A hidden garden with plants that emit soft light and play soothing EDM music",
    "A gladiator arena in ancient Rome where gladiators engage in dance battles",
    "A floating waterfall on an alien moon that turns into a water slide at night",
    "A space station orbiting a distant planet, where aliens attempt human dance moves",
    "A snowy village with colorful houses, hosting a snowball fight with surprise confetti",
    "An underwater city with transparent domes, where fish have a synchronized swimming team",
    "A medieval castle perched on a cliff, with knights engaging in a breakdance tournament",
    "A dance party with robots and humans in a time-traveling disco ball spaceship",
    "A tropical island with bioluminescent beaches, where fire-dancing is a nightly ritual",
    "A time-traveler meeting their future self and having a beatboxing showdown",
    "A hidden steampunk city beneath the surface, powered by hamster wheel generators",
    "A futuristic subway system with levitating trains, and commuters breakdancing",
    "A coral reef city with merfolk and marine creatures forming an underwater orchestra",
    "A wizard's tower surrounded by magical creatures who enjoy dubstep spellcasting",
    "An ancient colosseum hosting a mythical beast battle, but they end up forming a band",
    "A cityscape in a world where gravity works sideways, with sideways breakdancing",
    "A floating garden in the sky with flying flora, creating mesmerizing aerial patterns",
    "A high-speed race through a neon-lit canyon with DJ robots playing music",
    "A space explorer encountering an ancient alien civilization that communicates through dance",
    "A pirate ship sailing through a stormy sea, pirates engaging in a pirate-themed rap battle",
    "A lunar base with astronauts and advanced technology, organizing a zero-gravity dance-off",
    "A tribal village in a lush rainforest, where animals participate in a beatboxing contest",
    "A journey through a virtual reality wonderland filled with interactive dance challenges",
    "An enchanted desert with sand that shimmers like gold, hosting a sandcastle rave",
    "A hidden city within a massive crystal cavern, where crystals hum to the rhythm",
    "A colony on Mars with terraformed landscapes, Martians throwing a Martian Moonwalk party",
    "A labyrinthine library filled with endless books on interpretive dance and rhythmic poetry",
    "A massive treehouse village in a giant tree, where squirrels DJ for the forest party",
    "A concert of music played by creatures from different planets, forming a cosmic band",
    "A futuristic city where nature and technology coexist, with holographic graffiti artists",
    "An archaeological dig site with ancient artifacts that seem to groove to the music",
    "A coastal town in a world of perpetual sunset, where sunsets turn into salsa parties",
    "A cosmic circus with performers from across the universe, juggling black holes",
    "A serene zen garden with intricate stone arrangements, where meditating monks dance",
    "An intergalactic marketplace with traders from various species, bartering with dance moves",
    "A parallel dimension where reality shifts and bends, with mirror dimension dance battles",
    "A snow-covered city with steam-powered vehicles, hosting a snowman dance competition",
    "An underwater archaeological site with sunken ruins, where mermaids perform underwater ballet",
    "A factory where clouds are harvested and bottled, with cloud-shaped DJs mixing tunes",
    "A glacial ice cave with mesmerizing ice formations, where icicles play xylophones",
    "A city powered by renewable energy sources, with wind turbine DJs spinning tunes",
    "A secret garden hidden behind a waterfall, where fairies teach breakdancing to frogs",
    "An ancient observatory with celestial wonders, where stars form constellations of dance",
    "A society of sentient robots building their own civilization with synchronized movements",
    "A world where everyday objects possess magical abilities and dance to the beat",
    "A rainforest with bioluminescent flora and fauna, hosting a rave in the moonlit night",
    "An interstellar train traveling through wormholes, with passengers breakdancing through time",
    "A city where art and creativity are the primary currency, trading dance moves for goods",
    "An oasis in the middle of a vast desert, where dancers create oasis-themed choreography",
    "A futuristic amusement park with gravity-defying rides and rollercoaster dance-offs",
    "A sunken city beneath a calm and mysterious ocean, where mermaids groove to the currents"
  ];
